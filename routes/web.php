...
Route::get('/candidates/submit', \App\Http\Controllers\CandidateSubmitController::class)->name('candidates.submit');
Route::post('/candidates/submit', [\App\Http\Controllers\CandidateSubmitController::class, 'store'])->name('candidates.store');
